...
type LocationRepository interface {
	...
	FindAll(limit int) ([]domain.Location, error)
	FindNearby(longitude, latitude float64, radiusMeter, limit int) ([]domain.Location, error)
}
...
func (r *locationRepository) FindAll(limit int) ([]domain.Location, error) {
...
func (r *locationRepository) FindNearby(longitude, latitude float64, radiusMeter, limit int) ([]domain.Location, error) {
	var locations []domain.Location
